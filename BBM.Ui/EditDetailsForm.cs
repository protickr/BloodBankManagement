...
namespace BBM.Ui
{
    public partial class EditDetailsForm : MetroFramework.Forms.MetroForm
    {
        ...
        public EditDetailsForm(UserInfo loggedInUserInfo)
        {
            ...
            //userNameLabelEditDetailsForm.Text = loggedinUser.Name;
        }
        ...
        private void loadForm()
            {
            //received values for existing user to show in the form
            ...
            bloodGroupLabelEditDetailsForm.Text = loggedinUser.BloodGroup;
